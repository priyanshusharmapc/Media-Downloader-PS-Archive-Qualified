"""Regression policy for MDPS-AUDIT2-182 Retry Failed scope."""
...
retry=cpp[cpp.index("void ArchiveTab::retryFailed()"):cpp.index("void ArchiveTab::processImports",cpp.index("void ArchiveTab::retryFailed()")) if "void ArchiveTab::processImports" in cpp[cpp.index("void ArchiveTab::retryFailed()"):] else cpp.index("void ArchiveTab::runSources",cpp.index("void ArchiveTab::retryFailed()"))]
